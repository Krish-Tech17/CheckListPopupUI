...
public class ChecklistController : MonoBehaviour
{
    ...
    public void Show(string title, List<ChecklistData> checklistData, Action<List<ChecklistData>> submitCallback, Action closeCallback = null, string requiredWarningMessage = "Please complete all required fields.")
    {
        checklistPanel.SetActive(true);
        titleText.text = title;
